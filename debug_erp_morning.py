...
FILE_PATH = r"\\145.3.0.54\ofimatica\Supply Chain\PLAN PRODUCCION\List Avance Obra-Centro y Operacion\Listado Avance Obra - Centro y Operación (2026-02-19 06_06_48).xlsx"
...
if not df_target.empty:
    ...
    print(df_target[['O.F', 'Artículo', 'TEjec_Disp']])
else:
    print(f"\nOF {of_target} NOT FOUND in this file either.")
